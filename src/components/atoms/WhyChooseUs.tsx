    ...
    <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="relative z-10 max-w-7xl mx-auto py-12">
        ...
        <div className="mt-4 md:flex md:items-center md:justify-between">
          ...
          <div className="mt-6 md:mt-0 md:max-w-lg lg:max-w-xl">
            <p className="text-sm md:text-base text-gray-700">
              No matter which career, industry, or position you seek, our career
              coaching experts and PARWCC certified writers know how to show
              your value and impact so employers see you as the top candidate.
              With professional resume writing services, we have helped more
              than {statistics.applicantsHelped.toLocaleString()} applicants
              secure {statistics.interviewMultiplier}x more job interviews.
            </p>
          </div>
        </div>
        ...
        <div className="mt-12 flex justify-center">
          <button className="ml-4 px-6 py-3 font-semibold bg-[#67D794] border border-transparent hover:bg-white hover:border-[#67D794] text-black transition-colors duration-200">
