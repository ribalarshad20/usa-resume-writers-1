...
import sample01 from "../../../assets/visume/interactive-01.jpeg";
import sample02 from "../../../assets/visume/interactive-02.jpeg";
import sample03 from "../../../assets/visume/interactive-03.jpeg";
import sample04 from "../../../assets/visume/interactive-04.jpeg";
import sample05 from "../../../assets/visume/interactive-05.jpeg";
import sample06 from "../../../assets/visume/interactive-06.jpeg";
...
export const VisumeWorkSamples: React.FC = () => {
  const [showResumeForm, setShowResumeForm] = useState(false);
  const sampleData: PortfolioSample[] = [
    { imageUrl: sample01, alt: "Web Resume Sample 1" },
    { imageUrl: sample02, alt: "Web Resume Sample 2" },
    { imageUrl: sample03, alt: "Web Resume Sample 3" },
    { imageUrl: sample04, alt: "Web Resume Sample 4" },
    { imageUrl: sample05, alt: "Web Resume Sample 5" },
    { imageUrl: sample06, alt: "Web Resume Sample 6" },
  ];
...
export default VisumeWorkSamples;
